...
function s.efilter(e,re)
	return re:GetOwner()~=e:GetOwner() and re:IsActiveType(TYPE_EFFECT) and re:GetHandler():IsAttribute(ATTRIBUTE_WATER) 
end
--remove
...
function s.thfilter(c)
	return c:IsSetCard(0x22F) and c:IsAttribute(ATTRIBUTE_WATER) and c:IsAbleToHand()
end

...
function s.spfilter2(c,e,tp)
	return (c:IsLocation(LOCATION_GRAVE) or c:IsFaceup()) and c:IsLevel(1) and not c:IsCode(id) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end

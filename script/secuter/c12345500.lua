...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--spsummon itself when synchro material
...
function s.spcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(aux.FaceupFilter(Card.IsLevel,1),tp,LOCATION_MZONE,0,1,nil)
end

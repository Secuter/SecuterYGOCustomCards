...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		local mg1=Duel.GetMatchingGroup(s.filter0,tp,LOCATION_DECK+LOCATION_HAND,0,nil)
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local mg1=Duel.GetMatchingGroup(s.filter1,tp,LOCATION_DECK+LOCATION_HAND,0,nil,e)

...
function s.spfilter2(c,e,tp)
	return c:IsSetCard(SET_ETERNAL_STORM) and not c:IsCode(id) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_DEFENSE)
end
...
function s.thop2(e,tp,eg,ep,ev,re,r,rp,chk)
	local tg=Duel.GetFirstMatchingCard(s.thfilter2,tp,LOCATION_DECK,0,nil)
	if tg then

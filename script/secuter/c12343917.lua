...
function s.initial_effect(c)
	...
	e2:SetTarget(aux.TargetBoolFunction(Card.IsSetCard,SET_IRRADIANCE))
	e2:SetValue(500)
	c:RegisterEffect(e2)
	--special summon
...
function s.cfilter(c,e,tp)
	return c:IsSetCard(SET_IRRADIANCE) and c:IsAbleToRemoveAsCost() and aux.SpElimFilter(c,true)

...
function s.cfilter(c)
	return c:IsSetCard(SET_MORHAI) and c:IsDiscardable()
end
...
function s.spfilter(c,e,tp)
	return c:IsSetCard(SET_MORHAI) and c:IsType(TYPE_MONSTER) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end

...
function s.initial_effect(c)
	c:EnableReviveLimit()
	--Link Summon
	Link.AddProcedure(c,aux.FilterBoolFunctionEx(Card.IsSetCard,0x201),3)
	--extra mat
...
--indes
function s.indcon(e)
	return Duel.IsExistingMatchingCard(aux.FaceupFilter(Card.IsSetCard,0x201),e:GetHandlerPlayer(),LOCATION_PZONE,0,1,nil)
end
--set
...
function s.setfilter(c)
	return c:IsSetCard(0x201) and c:IsSpellTrap() and c:IsSSetable()
end

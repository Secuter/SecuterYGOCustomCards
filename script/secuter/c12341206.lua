...
function s.negcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return rp~=tp and not e:GetHandler():IsStatus(STATUS_BATTLE_DESTROYED)
		and re and re:IsActiveType(TYPE_TRAP) and Duel.IsChainNegatable(ev)
end
...
function s.thfilter(c,e,tp)
	return c:IsSetCard(SET_DD_INVADER) and c:IsType(TYPE_MONSTER) and c:GetCode()~=id and c:IsAbleToHand()
end

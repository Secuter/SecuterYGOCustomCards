...
function s.setfilter(c)
	return (c:IsLocation(LOCATION_GRAVE) or c:IsFaceup()) and c:IsSetCard(SET_DIVINE_DISCIPLE) and c:IsSpellTrap() and c:IsSSetable()
end
...
function s.thfilter(c)
	return c:IsSetCard(SET_DIVINE_DISCIPLE) and c:IsSpellTrap() and c:IsAbleToHand()
end

...
function s.op(e,tp,eg,ep,ev,re,r,rp)
	...
	if not Duel.IsPlayerCanSpecialSummonMonster(tp,88307371,0,0x4011,0,0,1,RACE_FISH,ATTRIBUTE_WATER) then return end
	local token=Duel.CreateToken(tp,88307371)

...
function s.initial_effect(c)
	--fusion summon
	c:EnableReviveLimit()
	Fusion.AddProcMix(c,true,true,aux.FilterBoolFunctionEx(Card.IsCracking),aux.FilterBoolFunctionEx(Card.IsAttribute,ATTRIBUTE_DARK))
...
function s.cfilter(c)
	return c:IsAttribute(ATTRIBUTE_DARK) and c:IsLevelAbove(8) and c:IsAbleToRemoveAsCost() and aux.SpElimFilter(c,true) 
end

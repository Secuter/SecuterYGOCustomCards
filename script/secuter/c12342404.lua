...
function s.thfilter(c)
	return c:GetOriginalCode()==12342415 and c:IsAbleToHand()
end
...
function s.thfilter2(c)
	return c:IsSetCard(0x21c) and c:IsType(TYPE_MONSTER) and not c:IsCode(id) and c:IsAbleToHand()
end

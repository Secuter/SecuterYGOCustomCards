...
function s.efilter(e,re)
	return re:GetOwner()~=e:GetOwner() and re:IsActiveType(TYPE_EFFECT) and re:GetHandler():IsAttribute(ATTRIBUTE_WIND) 
end
--search
...
function s.thfilter(c)
	return c:IsSetCard(SET_AMORPHIEND) and c:IsAttribute(ATTRIBUTE_WIND) and c:IsAbleToHand()
end

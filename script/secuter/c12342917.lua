...
function s.spcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(aux.FaceupFilter(Card.IsSetCard,SET_ETERNAL_STORM),tp,LOCATION_MZONE,0,1,nil)
end
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.SetPossibleOperationInfo(0,CATEGORY_NEGATE,g,1,0,0)
end
...
function s.thfilter(c)
	return c:IsSetCard(SET_ETERNAL_STORM) and c:IsSpellTrap() and c:IsAbleToHand()
end

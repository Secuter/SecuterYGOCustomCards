...
function s.initial_effect(c)
	...
	e1:SetHintTiming(0,TIMING_MSET+TIMINGS_CHECK_MONSTER+TIMING_ATTACK+TIMING_MAIN_END+TIMING_BATTLE_START+TIMING_BATTLE_END)
...
function s.thfilter(c,e,tp)
	return c:IsSetCard(SET_RASCAL_ACE) and c:IsType(TYPE_SPELL+TYPE_TRAP) and c:IsAbleToHand()
end

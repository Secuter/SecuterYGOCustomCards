...
function s.mgfilter(c,e,tp,sc,mg)
	return c:IsControler(tp) and c:IsLocation(LOCATION_GRAVE)
		and (c:GetReason()&(REASON_REUNION+REASON_MATERIAL))==REASON_REUNION+REASON_MATERIAL and c:GetReasonCard()==sc
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.SendtoDeck(tc,nil,0,REASON_EFFECT)~=0 and sumtype==SUMMON_TYPE_SPECIAL+SUMMON_TYPE_REUNION

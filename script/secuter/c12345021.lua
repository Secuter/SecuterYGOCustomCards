...
function s.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,Card.IsCrackingOrWyvern,1,false,nil,nil) end
	local g=Duel.SelectReleaseGroupCost(tp,Card.IsCrackingOrWyvern,1,1,false,nil,nil)

...
function s.filter(c,e,tp)
	return c:IsSetCard(SET_FLUID) and c:IsType(TYPE_MONSTER) and not c:IsCode(id) and c:IsSummonableCard() and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_DEFENSE)
end

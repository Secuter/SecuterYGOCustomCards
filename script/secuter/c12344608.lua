...
function s.descon1(e,tp,eg,ep,ev,re,r,rp)
	return not Duel.IsExistingMatchingCard(Card.IsAttribute,tp,LOCATION_GRAVE,0,1,nil,ATTRIBUTE_EARTH)
end
function s.descon2(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(Card.IsAttribute,tp,LOCATION_GRAVE,0,1,nil,ATTRIBUTE_EARTH)
end
...
function s.spfilter(c,ft,e,tp)
	return c:IsSetCard(SET_ANUAK) and c:IsMonster() and not c:IsReunion() and (c:IsLocation(LOCATION_GRAVE) or c:IsFaceup())

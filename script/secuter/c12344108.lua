...
function s.negcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return e:GetHandler()~=re:GetHandler() and not e:GetHandler():IsStatus(STATUS_BATTLE_DESTROYED) and Duel.IsChainNegatable(ev)
		and re:IsActiveType(TYPE_MONSTER) and activateLocation==LOCATION_MZONE
end

...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(s.tfilter,tp,LOCATION_DECK,0,1,nil,e,tp) end
...
function s.splimit(e,c)
	return not c:IsType(TYPE_SYNCHRO) and not c:IsRace(RACE_DRAGON) and c:IsLocation(LOCATION_EXTRA)
end

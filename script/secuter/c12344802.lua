...
function s.thfilter(c)
	return (c:IsSetCard(0x202) or c:IsSetCard(0x210)) and c:IsType(TYPE_MONSTER) and not c:IsCode(id) and c:IsAbleToHand()
end
...
function s.thfilter2(c,e,tp)
	return c:IsSetCard(0x202) and c:IsSetCard(0x210) and c:IsType(TYPE_SPELL+TYPE_TRAP) and c:IsAbleToHand()
end

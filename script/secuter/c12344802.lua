...
function s.thfilter(c)
	return (c:IsSetCard(SET_UNDEAD) or c:IsSetCard(SET_EAGLE_OVERSEER)) and c:IsType(TYPE_MONSTER) and not c:IsCode(id) and c:IsAbleToHand()
end
...
function s.thfilter2(c,e,tp)
	return c:IsSetCard(SET_UNDEAD) and c:IsSetCard(SET_EAGLE_OVERSEER) and c:IsType(TYPE_SPELL+TYPE_TRAP) and c:IsAbleToHand()
end

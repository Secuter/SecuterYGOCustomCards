...
function s.regop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetCurrentPhase()==PHASE_STANDBY then
        c:RegisterFlagEffect(id,RESET_EVENT+0x1fe3000+RESET_PHASE+PHASE_STANDBY,0,2)
	else
        c:RegisterFlagEffect(id,RESET_EVENT+0x1fe3000+RESET_PHASE+PHASE_STANDBY,0,1)
	end
end
--negate
...
function s.thfilter(c,e,tp)
	return c:IsSetCard(0x215) and c:IsType(TYPE_SPELL+TYPE_TRAP) and c:IsAbleToHand()
end

...
function s.initial_effect(c)
	c:EnableReviveLimit()
	--Reverse-Xyz Summon
	ReverseXyz.AddProcedure(c,2,aux.FilterBoolFunctionEx(Card.IsRace,RACE_FIEND),aux.FilterBoolFunctionEx(Card.IsRace,RACE_FIEND))
	--lv change
